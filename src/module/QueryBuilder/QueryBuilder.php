...
namespace timanthonyalexander\BaseApi\module\QueryBuilder;

use Exception;
use PDOException;
use RuntimeException;
use timanthonyalexander\BaseApi\module\BetterSQL\BetterSQL;
...
use timanthonyalexander\BaseApi\module\PrettyJson\PrettyJson;
...
class QueryBuilder
{
    ...
    private function cachedExecute(
        ...
        try {
            ...
            Page::log('EXCEPTION Query' . PHP_EOL . $query . PHP_EOL . ' [' . $e->getMessage() . ']', 'errors.log');
            throw $e;
        }
