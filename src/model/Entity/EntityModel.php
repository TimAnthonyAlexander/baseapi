...
namespace timanthonyalexander\BaseApi\model\Entity;

use Exception;
use ReflectionClass;
use timanthonyalexander\BaseApi\model\Data\DataModel;
use timanthonyalexander\BaseApi\module\ContextCache\ContextCache;
...
class EntityModel extends DataModel
{
    ...
    public function __construct(
        ...
        if ($this->id === 'new_') {
            $this->id = base64_encode(uniqid('coacreate_', true));
        } else {
            $this->load($this->id);
        }
    }
